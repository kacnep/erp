        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'admin.project.store', 'class' => 'form-horizontal', 'files' => 'true']) !!}

                    <div class="form-group row">
                        {!! Form::label('user', 'User: *', ['class' => 'col-sm-4 col-form-label text-right']) !!}
                        <div class="col-sm-7">
                            {!! Form::select('user', \App\User::all()->pluck('name', 'id')->toArray(), Auth::id(), ['class' => 'form-control', 'required' => 'required']) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            {!! Form::textarea('skills', null, ['class' => $errors->has('skills') ? 'form-control is-invalid' : 'form-control', 'required' => 'required', 'placeholder' => 'Skills (1 per line)']) !!}
