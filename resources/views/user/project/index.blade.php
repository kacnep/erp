                ...
                <div class="card">
                    ...
                    <div class="card-body" >
                        ...
                        <div class="row form-group">
                            <div class="col-auto">
                                <a href="{{ route('user.project.create') }}" class="btn  btn-primary">Create Project</a>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('user.project.downloadExample') }}" class="btn btn-info">Download Example</a>
                            </div>
                            <div class="col-auto">

                                {!! Form::open(['route' => 'user.project.importExcel', 'class' => 'form-horizontal', 'files' => 'true']) !!}
                        ...
                        <div id="ajax-loader">
                            @include('user.project.include.ajax-loader', compact('preojects', 'data'))
                        </div>
